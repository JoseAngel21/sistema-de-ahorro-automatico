...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_sistema.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel_sistema.setText("system");
        barra.add(jLabel_sistema, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 0, 70, 30));

        jLabel_sistema1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel_sistema1.setText("Automatic Savings");
        barra.add(jLabel_sistema1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 180, 30));

        btn_ver_cerrar.setBackground(new java.awt.Color(102, 102, 102));
        btn_ver_cerrar.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        btn_ver_cerrar.setText("X");
        btn_ver_cerrar.setBorder(null);
        barra.add(btn_ver_cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 0, 40, 30));

        bg.add(barra, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 840, 30));

        nav.setBackground(new java.awt.Color(102, 102, 102));
        nav.setForeground(new java.awt.Color(102, 102, 102));
        nav.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btn_clientes.setBackground(new java.awt.Color(102, 102, 102));
        btn_clientes.setForeground(new java.awt.Color(51, 51, 255));
        ...
        jLabelPrincipal.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        btn_productos.setBackground(new java.awt.Color(102, 102, 102));
        ...
        jLabelRegistro.setBackground(new java.awt.Color(102, 102, 102));
        ...
        btn_deudas.setBackground(new java.awt.Color(102, 102, 102));
        ...
        jLabelMaterias.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        btn_abonos.setBackground(new java.awt.Color(102, 102, 102));
        ...
        jLabelNotas.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Automatic Savings system.png"))); // NOI18N
        ...
        nav.add(btn_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 460, 170, -1));
        ...
        panel_clientes.setBackground(new java.awt.Color(102, 102, 102));
        ...
        label_clientes.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        label_direccion.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        label_direccion.setText("Producto");
        ...
        label_telefono.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btn_eliminar_cliente.setBackground(new java.awt.Color(153, 153, 153));
        btn_eliminar_cliente.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btn_registrar_cliente.setBackground(new java.awt.Color(153, 153, 153));
        btn_registrar_cliente.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        cb_direccion.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        cb_direccion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Severa", "Valparaiso", "Berengena", "Palotal", "Chorrillo" }));
        cb_direccion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cb_direccionActionPerformed(evt);
            }
        });
        ...
        tabla_clientes.setBackground(new java.awt.Color(153, 153, 153));
        ...
        panel_productos.setBackground(new java.awt.Color(102, 102, 102));
    ...
    private void cb_direccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_direccionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cb_direccionActionPerformed
